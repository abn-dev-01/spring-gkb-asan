 ...
 *         &lt;element name="responseStatus" type="{http://data.gbd.chdb.scb.kz/}StatusInfo"/&gt;
...
public class SyncMessageInfoResponse {
    ...
    @XmlElement(required = true)
    protected StatusInfo responseStatus;
     ...
     *     
     */
    public void setResponseStatus(StatusInfo value) {
